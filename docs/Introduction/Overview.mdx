...
1. [Sign up for an account](../Getting-Started/signing-up.mdx)
2. [Create your first project](../Projects/creating-a-project.mdx)
3. [Run your first assessment](../Projects/running-tests.mdx)
